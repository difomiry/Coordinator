...
public class AnyCoordinatable<InputType, OutputType> {
  ...
  private let coordination: (InputType, CoordinatorCompletion<OutputType>?) -> Void
...
extension AnyCoordinatable: Coordinatable {
  ...
  public func start(with input: InputType, completion: CoordinatorCompletion<OutputType>?) {
